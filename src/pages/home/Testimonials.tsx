...
export default function Testimonials() {
  return (
    <Box mt={10} bgcolor={"#F5F8FF"} sx={{
        position:"relative",
        
      }} p={"30px"}>
        <Box sx={{position:"absolute",width:"100%",height:"100%",boxShadow: {md:`
        ...
        m:"-30px"}}>
          ...
          <Grid container  width={"100%"} alignItems={{xs:"center"}} justifyContent={"center"} spacing={3}>
          ...
          <Grid container width={{xs:"100%",md:"120%"}} alignItems={{xs:"center"}} sx={{marginLeft:{md:"-10%"}}} flexWrap={{md:"nowrap"}} spacing={3}>
